...
export default function Home() {
  return (
    <div className="flex flex-col justify-between h-screen" >
      ...
      height={400}
    />
    <div className="sm:absolute sm:w-3/6 p-5 rounded-lg shadow-lg top-20 left-10 bg-red-50 bg-opacity-60 ">
      <h3 className="p-5 text-3xl text-green-700 font-sat" >Our business is making memories</h3>
      <p className="ml-5 text-gray-500 font-sat text-xl " >Thank you for letting us share in this joyful day. We wish you all the best as you embark on this wonderful union.</p>
      <p className="m-5 text-gray-500 font-sat text-xl" >Now the planning for the most important day will begin.</p>
      <div className="" >
