                            ...
                            <div className="overflow-hidden shadow sm:rounded-md">
                                ...
                                <div className="px-4 py-3 text-right bg-gray-50 sm:px-6">
                                    <center>
                                        <button
                                            type="submit"
                                            className="inline-flex justify-center px-10 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm 5 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                        >
                                            Add Service
                                        </button>
                                    </center>
