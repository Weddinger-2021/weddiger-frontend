    ...
    return (
        <div className = "flex flex-wrap m-10">
          ...
          <section key={i} className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden m-5" >
            ...
            <Link className="text-center " href='/category/[pid].js' as={`/category/${category.id}`}><a className=" font-head1 text-green-900 text-2xl hover:text-green-500" >{category.name}</a></Link>      
            </div> 
        </section>
    )}
          </div>
